...
public class Elevator extends Thread {
    ...
    public Elevator(int buildingId, RequestQueue waitingQueue) {
        this.nowFloor = 1;
    ...
    private void up() {
        ...
        //ARRIVE-所在座-所在层-电梯ID
        SafeOut.println("ARRIVE-" + buildingName + "-" + nowFloor + "-" + buildingId);
    }
    ...
    private void openClose() {
        ...
        SafeOut.println("OPEN-" + buildingName + "-" + nowFloor + "-" + buildingId);
        alsTragedy();
        passengerOut();
        try {
            sleep(200);
        ...
        passengerIn();
        //CLOSE-所在座-所在层-电梯ID
        SafeOut.println("CLOSE-" + buildingName + "-" + nowFloor + "-" + buildingId);
    }
